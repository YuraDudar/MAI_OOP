...
bool Octagon::operator==(const Octagon &other) {
    std::vector<Point> pts = {p1, p2, p3, p4, p5, p6, p7, p8, p1, p2, p3, p4, p5, p6, p7, p8};
    std::vector<Point> opts = {other.p1, other.p2, other.p3, other.p4, other.p5, other.p6, other.p7, other.p8};
    bool flag = false;
